  ...
  return (
    <div className="auth-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="auth-panel">
        ...
        <h2 className="auth-title">Verses</h2>
        <p className="auth-subtitle">{mode === 'signin' ? 'Welcome back' : 'Create your account'}</p>

        <div className="auth-oauth">
          <button className="auth-oauth-btn" onClick={() => handleOAuth(signInWithGoogle)}>
          ...
          <button className="auth-oauth-btn" onClick={() => handleOAuth(signInWithGitHub)}>
